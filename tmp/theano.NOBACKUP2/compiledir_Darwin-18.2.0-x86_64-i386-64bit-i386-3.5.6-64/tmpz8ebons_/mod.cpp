...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed() {
        ...
        ~__struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_13;}
                ...
                V11_jumpx_1 = -(V11_n2*V11_stride2);
...
dims[2] = V5_n2;
        ...
        if (!V1) {
            V1 = (PyArrayObject*)PyArray_EMPTY(3, dims,
                                                    NPY_FLOAT32,
                                                    PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V5) && PyArray_ISFORTRAN(V7) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V11));
        }
        else {
            ...
            if (!success) {
                ...
                PyErr_Clear();
                Py_XDECREF(V1);
                V1 = (PyArrayObject*)PyArray_EMPTY(3, dims, NPY_FLOAT32, 0);
            } else {
                Py_DECREF(success);
            }
        }
        ...
        goto __label_13;}
                ...
                V1_stride2 = PyArray_STRIDES(V1)[2] / sizeof(npy_float32);
                ...
                
{
    ...
    int init_totals[3] = {V3_n0, V3_n1, V5_n2};
    ...
    int init_strides[6][3] = {
        V3_stride0, V3_stride1, 0, 
V5_stride0, 0, V5_stride2, 
V7_stride0, V7_stride1, 0, 
V9_stride0, V9_stride1, 0, 
V11_stride0, 0, V11_stride2, 
V1_stride0, V1_stride1, V1_stride2
    ...
    std::vector< std::pair<int, int> >::reverse_iterator V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V7_stride_l2 = init_strides[2][V1_loops_rit->second];
            ++V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V9_stride_l2 = init_strides[3][V1_loops_rit->second];
            ++V1_loops_rit;
        ...
        V1_loops_rit = V1_loops.rbegin();
            int V1_stride_l2 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l1 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
            
            int V1_stride_l0 = init_strides[5][V1_loops_rit->second];
            ++V1_loops_rit;
...
npy_float32 &V1_i = * ( V1_iter+V1_stride_l2*ITER_2+V1_stride_l1*ITER_1+V1_stride_l0*ITER_0);
...
V13_tmp2 = V9_i * V11_i * V13_tmp1;
npy_float32 V13_tmp3;
V13_tmp3 = V3_i * V5_i * V13_tmp1;
V1_i = V13_tmp3 - V13_tmp2;
}
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed_executor(__struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed *self) {
            return self->run();
        }

        static void __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed_destructor(PyObject *capsule) {
            __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed *self = (__struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed* struct_ptr = new __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5),PyTuple_GET_ITEM(argtuple, 6) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed_executor), NULL, __struct_compiled_op_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m769f0a7e28e678045473a782d3843f2366200bca9300c60777d95c73dcd378ed(void) {
   import_array();
