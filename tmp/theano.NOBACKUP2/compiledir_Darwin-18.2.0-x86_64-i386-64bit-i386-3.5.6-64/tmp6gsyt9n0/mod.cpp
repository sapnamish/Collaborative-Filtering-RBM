...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e() {
        ...
        ~__struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e(void) {
            cleanup();
        }
...
V1_iter = (npy_float32*)(PyArray_DATA(V1));
        ...
        for (int ITER_0 = 0; ITER_0<V1_n0; ITER_0++) {
            npy_int64 &V3_i = * ( V3_iter + ITER_0 * V3_jumpx_0 );
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e_executor(__struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e *self) {
            return self->run();
        }

        static void __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e_destructor(PyObject *capsule) {
            __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e *self = (__struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e* struct_ptr = new __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2) ) != 0) {
    delete struct_ptr;
    return NULL;
  }
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e_executor), NULL, __struct_compiled_op_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_mbb0a9b791b7bd6f021bfa4d4288606fd42886c4d829119236e1ba95568e6896e(void) {
   import_array();
