...
//////////////////////
    ...
    namespace {
    struct __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880 {
        PyObject* __ERROR;
...
PyObject* storage_V1;
        ...
        __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880() {
        ...
        ~__struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880(void) {
            cleanup();
        }
...
// Op class Elemwise
        ...
        goto __label_11;}
            ...
            if((PyArray_ISCONTIGUOUS(V3) && PyArray_ISCONTIGUOUS(V9) && PyArray_ISCONTIGUOUS(V1)) || (PyArray_ISFORTRAN(V3) && PyArray_ISFORTRAN(V9) && PyArray_ISFORTRAN(V1))){
...
double __DUMMY_2;
        ...
        static int __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880_executor(__struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880 *self) {
            return self->run();
        }

        static void __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880_destructor(PyObject *capsule) {
            __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880 *self = (__struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880 *)PyCapsule_GetContext(capsule);
            delete self;
        }
...
static PyObject * instantiate(PyObject * self, PyObject *argtuple) {
  ...
  __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880* struct_ptr = new __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880();
  if (struct_ptr->init( PyTuple_GET_ITEM(argtuple, 0),PyTuple_GET_ITEM(argtuple, 1),PyTuple_GET_ITEM(argtuple, 2),PyTuple_GET_ITEM(argtuple, 3),PyTuple_GET_ITEM(argtuple, 4),PyTuple_GET_ITEM(argtuple, 5) ) != 0) {
    ...
    PyObject* thunk = PyCapsule_New((void*)(&__struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880_executor), NULL, __struct_compiled_op_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880_destructor);
...
static struct PyModuleDef moduledef = {
      ...
      "m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880",
      NULL,
      -1,
      MyMethods,
};

PyMODINIT_FUNC PyInit_m899509f8e7430421d008f9b098a1fbf7f648caac49bf4565d40f8b4fab8b1880(void) {
   import_array();
