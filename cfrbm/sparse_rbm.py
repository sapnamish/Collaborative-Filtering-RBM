...
class CFRBM:
    ...
    def gradient_regularizer(self, h1, dp):
        gp = dp - h1.mean(axis=0)

        return gp

    def cdk_fun(self, vis, masks, k=1, w_lr=0.000021, v_lr=0.000025,
                h_lr=0.000025, decay=0.0000, momentum=0.0, sparsity=0.01, p_lr=0.000001):
        ...
        P = self.gradient_regularizer(h1, sparsity)
