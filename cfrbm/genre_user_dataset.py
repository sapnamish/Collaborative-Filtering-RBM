...
def load_dataset(train_path, test_path, user_path, movie_path, sep, user_based=True):
    all_users_set = set()
    all_movies_set = set()
    ...
    all_genres_set = ['unknown','Action','Adventure','Animation',
    ...
    return list(all_users_set), list(all_movies_set), list(all_occs_set), list(all_sex_set), list(all_ages_set), list(all_genres_set), tests
