...
class CFRBM:
    def __init__(self, num_visible_x, num_visible_o, num_visible_s, num_visible_a, num_hidden, initial_v_x=None,
                initial_v_o=None, initial_v_s=None, initial_v_a=None, initial_weights_x=None, initial_weights_o=None, 
                initial_weights_s=None, initial_weights_a=None, debug=False):
    ...
    def prop_up(self, vis, occ, sex, age):
        return T.nnet.sigmoid(T.dot(vis, self.weights_x) + T.dot(occ, self.weights_o) 
            + T.dot(sex, self.weights_s) + T.dot(age, self.weights_a) + self.hbias)

    def sample_hidden(self, vis, occ, sex, age):
        activations = self.prop_up(vis, occ, sex, age)
    ...
    def contrastive_divergence_1(self, v1_x, v1_o, v1_s, v1_a):
        h1, _ = self.sample_hidden(v1_x, v1_o, v1_s, v1_a)
        ...
        h2, h2a = self.sample_hidden(v2_x, v2_o, v2_s, v2_a)

        return (v1_x, v1_o, v1_s, v1_a, h1, v2_x, v2a_x, v2_o, v2a_o, v2_s, v2a_s, v2_a, v2a_a, h2, h2a)

    def gradient(self, v1_x, v1_o, v1_s, v1_a, h1, v2_x, v2_o, v2_s, v2_a, h2p, masks_x, masks_o, masks_s, masks_a):
        ...
        return (gw_x, gw_o, gw_s, gw_a, gv_x, gv_o, gv_s, gv_a, gh)

    def cdk_fun(self, vis_x, vis_o, vis_s, vis_a, masks_x, masks_o, masks_s, masks_a, k=1, w_lr=0.000021, v_lr=0.000025,
                h_lr=0.000025, decay=0.0000, momentum=0.0):
        v1_x, v1_o, v1_s, v1_a, h1, v2_x, v2a_x, v2_o, v2a_o, v2_s, v2a_s, v2_a, v2a_a, h2, h2a = self.contrastive_divergence_1(vis_x, vis_o, vis_s, vis_a)

        for i in range(k-1):
            v1_x, v1_o, v1_s, v1_a, h1, v2_x, v2a_x, v2_o, v2a_o, v2_s, v2a_s, v2_a, v2a_a, h2, h2a = self.contrastive_divergence_1(v2_x, v2_o, v2_s, v2_a)

        (W_x, W_o, W_s, W_a, V_x, V_o, V_s, V_a, H) = self.gradient(v1_x, v1_o, v1_s, v1_a, h1, v2_x, v2_o, v2_s, v2_a, h2a, masks_x, masks_o, masks_s, masks_a)
        ...
        return theano.function([vis_x, vis_o, vis_s, vis_a, masks_x, masks_o, masks_s, masks_a], updates=updates)

    def predict(self, v1_x, v1_o, v1_s, v1_a):
        h1, _ = self.sample_hidden(v1_x, v1_o, v1_s, v1_a)
        v2_x, v2a_x = self.sample_visible_x(h1)
        #v2_g, v2a_g = self.sample_visible_g(h1)
        return theano.function([v1_x, v1_o, v1_s, v1_a], v2a_x)
